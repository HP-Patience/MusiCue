...
<p align="center">
  ...
  <a href="https://github.com/HP-Patience/MusiCue"><img src="https://img.shields.io/github/languages/top/HP-Patience/MusiCue?style=flat-square" alt="主要编程语言"></a>
  <a href="https://github.com/HP-Patience/MusiCue/commits/master"><img src="https://img.shields.io/github/last-commit/HP-Patience/MusiCue?style=flat-square" alt="最近提交"></a>
  <a href="https://github.com/HP-Patience/MusiCue/issues"><img src="https://img.shields.io/github/issues/HP-Patience/MusiCue?style=flat-square" alt="开放问题"></a>
</p>
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      <img src="./assets/readme/floating-input-light.png" width="100%" alt="计划中的 MusiCue 浅色贴边悬浮输入条">
      <strong>贴边悬浮输入 · 浅色</strong><br>
      计划作为常驻屏幕边缘的快速入口，点击即可打开 MusiCue 并立即向 DJ 提出请求。
    </td>
    <td width="50%" valign="top">
      <img src="./assets/readme/floating-input-dark.png" width="100%" alt="计划中的 MusiCue 深色贴边悬浮输入条">
      <strong>贴边悬浮输入 · 深色</strong><br>
      同一悬浮入口适配深色听歌主题。
    </td>
  </tr>
</table>
...
- [ ] **贴边悬浮球** — 在屏幕边缘常驻一个紧凑悬浮入口，点击即可打开 MusiCue，快速开始一次听歌请求。
- [ ] **自动检查更新** — 自动检查 MusiCue 的新版本，并在有可用更新时提醒用户。
